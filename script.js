const contentData = [
    ...
    { id: 181, title: 'Crash Landing on You', type: 'series', imdbId: 'tt10850932', year: 2019, rating: '8.7', quality: '4K', desc: 'A South Korean heiress accidentally paraglides into North Korea and meets a captain.', langs: ['Korean', 'English'], poster: 'https://image.tmdb.org/t/p/w500/fgBNLPr6mC8pxuR79ENAJY4nBmj.jpg' },
    ...
    { id: 187, title: 'Extraordinary Attorney Woo', type: 'series', imdbId: 'tt20869502', year: 2022, rating: '8.6', quality: '4K', desc: 'A brilliant autistic attorney navigates law and life in Seoul.', langs: ['Korean', 'English'], poster: 'https://image.tmdb.org/t/p/w500/zuNOQVI4rEaqwknrfQUVKtlKE2C.jpg' },
    { id: 188, title: 'All of Us Are Dead', type: 'series', imdbId: 'tt14169960', year: 2022, rating: '7.7', quality: '4K', desc: 'Students trapped in a high school fight for survival during a zombie outbreak.', langs: ['Korean', 'English'], poster: 'https://image.tmdb.org/t/p/w500/pTEFqAjLd5YTsMD6NSUxV6Dq7A6.jpg' },
    { id: 189, title: 'Descendants of the Sun', type: 'series', imdbId: 'tt4925000', year: 2016, rating: '8.3', quality: '4K', desc: 'A soldier and a doctor fall in love amid war and disaster.', langs: ['Korean', 'English'], poster: 'https://image.tmdb.org/t/p/w500/xxGomfml0x9iyPBS4StBjbRRu65.jpg' },
    ...
    { id: 191, title: 'Reply 1988', type: 'series', imdbId: 'tt5182866', year: 2015, rating: '8.8', quality: '4K', desc: 'Five childhood friends and their families navigate life in 1988 Seoul.', langs: ['Korean', 'English'], poster: 'https://image.tmdb.org/t/p/w500/i3xQJlQRff4k5IMEY55l4iKaKl3.jpg' },
    ...
    { id: 197, title: 'Hotel del Luna', type: 'series', imdbId: 'tt10220588', year: 2019, rating: '8.2', quality: '4K', desc: 'A hotel manager runs a mystical hotel for ghosts in Seoul.', langs: ['Korean', 'English'], poster: 'https://image.tmdb.org/t/p/w500/8bizZsXoAsOTbhyFKfBogC8mgG2.jpg' },
    ...
    { id: 200, title: 'Don\'t Look Up', type: 'movie', imdbId: 'tt11286314', year: 2021, rating: '7.2', quality: '4K', desc: 'Two astronomers try to warn humanity about an approaching comet.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/th4E1yqsE8DGpAseLiUrI60Hf8V.jpg' },
    { id: 201, title: 'Bird Box', type: 'movie', imdbId: 'tt2737304', year: 2018, rating: '6.6', quality: '4K', desc: 'A woman must blindfold herself to survive entities that drive people to suicide.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/rGfGfgL2pEPCfhIvqHXieXFn7gp.jpg' },
    { id: 202, title: 'Red Notice', type: 'movie', imdbId: 'tt7991608', year: 2021, rating: '6.3', quality: '4K', desc: 'An FBI agent chases two criminals in a global art heist.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/lAXONuqg41NwUMuzMiFvicDET9Y.jpg' },
    { id: 203, title: 'The Gray Man', type: 'movie', imdbId: 'tt1649418', year: 2022, rating: '6.5', quality: '4K', desc: 'A CIA agent uncovers dark agency secrets and becomes a target.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/8cXbitsS6dWQ5gfMTZdorpAAzEH.jpg' },
    { id: 204, title: 'Glass Onion', type: 'movie', imdbId: 'tt11564570', year: 2022, rating: '7.3', quality: '4K', desc: 'Detective Benoit Blanc solves a murder on a Greek island billionaire retreat.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/vDGr1YdrlfbU9wxTOdpf3zChmv9.jpg' },
    { id: 205, title: 'Extraction', type: 'movie', imdbId: 'tt8936646', year: 2020, rating: '7.0', quality: '4K', desc: 'A black-market mercenary embarks on a mission to rescue a drug lord\'s son.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/nygOUcBKPHFTbxsYRFZVePqgPK6.jpg' },
    { id: 206, title: 'The Old Guard', type: 'movie', imdbId: 'tt7556122', year: 2020, rating: '6.6', quality: '4K', desc: 'A group of immortal mercenaries must protect their secret.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/cjr4NWURcVN3gW5FlHeabgBHLrY.jpg' },
    { id: 207, title: 'The Adam Project', type: 'movie', imdbId: 'tt2463208', year: 2022, rating: '6.7', quality: '4K', desc: 'A time-traveling pilot teams up with his younger self to save the future.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/wFjboE0aFZNbVOF05fzrka9Fqyx.jpg' },
    { id: 208, title: 'Leave the World Behind', type: 'movie', imdbId: 'tt12747748', year: 2023, rating: '6.5', quality: '4K', desc: 'A family vacation turns into a nightmare when technology collapses.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/29rhl1xopxA7JlGVVsf1UHfYPvN.jpg' },
    { id: 209, title: 'Rebel Moon', type: 'movie', imdbId: 'tt14998742', year: 2023, rating: '5.6', quality: '4K', desc: 'A warrior leads a rebellion against a tyrannical regent.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/ui4DrH1cKk2vkHshcUcGt2lKxCm.jpg' },
    { id: 210, title: 'Damsel', type: 'movie', imdbId: 'tt13452446', year: 2024, rating: '6.2', quality: '4K', desc: 'A young woman fights for survival after being sacrificed to a dragon.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/AgHbB9DCE9aE57zkHjSmseszh6e.jpg' },
    ...
    { id: 214, title: 'The Mother', type: 'movie', imdbId: 'tt6968614', year: 2023, rating: '6.2', quality: '4K', desc: 'A former assassin comes out of hiding to protect her daughter.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/vnRthEZz16Q9VWcP5homkHxyHoy.jpg' },
    { id: 215, title: 'Heart of Stone', type: 'movie', imdbId: 'tt13603966', year: 2023, rating: '6.0', quality: '4K', desc: 'A spy races against time to stop a hacker from stealing a dangerous weapon.', langs: ['Hindi', 'English'], poster: 'https://image.tmdb.org/t/p/w500/vB8o2p4ETnrfiWEgVxHmHWP9yRl.jpg' },
